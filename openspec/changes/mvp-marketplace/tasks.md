...
| 2 | maxkeys-back | Order domain | `feat/mvp-02-order-domain` | `feat/mvp-01b-domain-outbox` → `main` after PR1b | 1b | ~380 | 1 | `dotnet test tests/Maxkeys.Domain.Tests --filter Order` | N/A | delete `Orders/`, `Keys/`; revert cart-checkout spec edit |
