...
- Test (PR9b): `dotnet test tests/Maxkeys.Api.Tests` green — 12/12 (adds 6 checkout tests on top of PR9a's 6). Full solution: Domain 56/56, Application 51/51, 0 build warnings.
